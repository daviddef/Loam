...
| Elements | **6,495** (6,139 workshop · 356 folklore) |
| Recipes | **8,400** (7,475 merges · 925 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **6,495 / 6,495** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **8,400 / 8,400** recipes, every URL machine-verified |
...
| Routes per element | **1.29** · 4,965 still needing a second route · 1,879 sole-route by design |
| Hazards | **343**, covering 621 elements |
| Scale span | **19 orders of magnitude**, from a carbon atom to the sun |
| Drawings | **6,495**, none of them emoji |
