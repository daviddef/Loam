...
const SCALE = {
  ...
  '-2':  ['lard', 'wool', 'embryo', 'stone', 'flint', 'limestone', 'ice', 'brick', 'adobe', 'mortar', 'candle',
  ...
  '-1':  ['book', 'fetus', 'duck', 'turkey', 'koala', 'platypus', 'cloth', 'clothing', 'paper', 'pulp', 'flax', 'water', 'mud', 'soil', 'tempered_clay', 'concrete', 'fire', 'steam',
