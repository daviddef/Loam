...
| Elements | **7,518** (7,162 workshop · 356 folklore) |
| Recipes | **9,378** (8,440 merges · 938 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,518 / 7,518** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,378 / 9,378** recipes, every URL machine-verified |
...
| Routes per element | **1.25** · 6,030 still needing a second route · 1,875 sole-route by design |
| Hazards | **343**, covering 621 elements |
| Scale span | **19 orders of magnitude**, from a carbon atom to the sun |
| Drawings | **7,518**, none of them emoji |
