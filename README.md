...
| Elements | **7,569** (7,213 workshop · 356 folklore) |
| Recipes | **9,443** (8,491 merges · 952 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,569 / 7,569** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,443 / 9,443** recipes, every URL machine-verified |
...
| Routes per element | **1.25** · 6,077 still needing a second route · 1,869 sole-route by design |
| Hazards | **343**, covering 621 elements |
| Scale span | **19 orders of magnitude**, from a carbon atom to the sun |
| Drawings | **7,569**, none of them emoji |
