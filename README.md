...
| Elements | **7,567** (7,211 workshop · 356 folklore) |
| Recipes | **9,438** (8,491 merges · 947 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,567 / 7,567** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,438 / 9,438** recipes, every URL machine-verified |
...
| Routes per element | **1.25** · 6,076 still needing a second route · 1,869 sole-route by design |
| Hazards | **343**, covering 621 elements |
| Scale span | **19 orders of magnitude**, from a carbon atom to the sun |
| Drawings | **7,567**, none of them emoji |
