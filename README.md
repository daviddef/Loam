...
| Elements | **348** (339 workshop · 9 folklore) |
| Recipes | **611** (451 merges · 160 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **348 / 348** from the four starters |
| Deepest chain | 27 crafts |
| Sourced | **611 / 611** recipes, every URL machine-verified |
| Audited | **229** of 611 claims checked against primary reporting — **48 were wrong** |
...
| Drawings | **357**, none of them emoji |
...
**The 357 drawings** are built from a kit of about forty parts on a 60x60 grid —
...
tools/art.mjs            the parts kit, all 357 drawings, and a sameness check
...
1. **Art — done.** All 348 items are drawn, plus the six process verbs. The
...
2. **Audit.** 229 of 611 claims have been checked against primary reporting and
