...
| Elements | **8,282** (7,926 workshop · 356 folklore) |
| Recipes | **10,231** (9,252 merges · 979 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **8,282 / 8,282** from the four starters |
| Sourced | **10,231 / 10,231** recipes, every URL machine-verified |
| Independently verified | **8,151 / 10,231** (80%) carry `verified: true` |
| Routes per element | **1.24** · 6,722 still have exactly one |
| Hazards | **343**, covering 621 elements |
| Scale span | **20 orders of magnitude**, 10^-10 m to 10^9 m |
| Drawings | **7,875** hand-drawn; 407 on a family fallback — a tracked backlog, not a blocker |
| Roles | **8,282 / 8,282** — what each noun is to a making |
| Sense-checked | **1,780** single-word names read; 152 on the watchlist |
| Places | **442 / 442** of a checklist that is part external, so it can disagree with us |
| Parts lists | **403** written |
...
while the corpus held 7,423 — and then did it again, claiming 7,576 against 8,282.*
<!-- STATUS:END -->
