...
| Elements | **8,392** (8,036 workshop · 356 folklore) |
| Recipes | **10,341** (9,362 merges · 979 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **8,392 / 8,392** from the four starters |
| Sourced | **10,341 / 10,341** recipes, every URL machine-verified |
| Independently verified | **8,261 / 10,341** (80%) carry `verified: true` |
| Routes per element | **1.23** · 6,832 still have exactly one |
| Hazards | **343**, covering 621 elements |
| Scale span | **20 orders of magnitude**, 10^-10 m to 10^9 m |
| Drawings | **7,875** hand-drawn; 517 on a family fallback — a tracked backlog, not a blocker |
| Roles | **8,367 / 8,392** — what each noun is to a making |
...
| Effects on a body | **450 / 621** cautioned elements answered and **36 / 39** of the nutrients a body cannot make supplied; 63 rows are things the body is better off for, 5 elements are both, 5 carry a dose ladder; **334 / 334** have had the article they cite read and found to carry the claim |
...
while the corpus held 7,423 — and then did it again, claiming 7,576 against 8,392.*
<!-- STATUS:END -->
