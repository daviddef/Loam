...
| Recipes | **9,376** (8,438 merges · 938 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,508 / 7,508** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,376 / 9,376** recipes, every URL machine-verified |
...
| Routes per element | **1.25** · 6,018 still needing a second route · 1,870 sole-route by design |
