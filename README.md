...
| Recipes | **9,445** (8,493 merges · 952 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,571 / 7,571** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,445 / 9,445** recipes, every URL machine-verified |
...
| Routes per element | **1.25** · 6,079 still needing a second route · 1,869 sole-route by design |
