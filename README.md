...
| Elements | **7,566** (7,210 workshop · 356 folklore) |
| Recipes | **9,437** (8,490 merges · 947 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,566 / 7,566** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,437 / 9,437** recipes, every URL machine-verified |
...
| Routes per element | **1.25** · 6,075 still needing a second route · 1,869 sole-route by design |
| Hazards | **343**, covering 621 elements |
| Scale span | **19 orders of magnitude**, from a carbon atom to the sun |
| Drawings | **7,566**, none of them emoji |
