...
| Elements | **7,571** (7,215 workshop · 356 folklore) |
| Recipes | **9,467** (8,515 merges · 952 verb processes) |
| Starters | Stone · Water · Sun · Seed |
| Reachable | **7,571 / 7,571** from the four starters |
| Deepest chain | 51 crafts |
| Sourced | **9,467 / 9,467** recipes, every URL machine-verified |
...
| Drawings | **7,571**, none of them emoji |
